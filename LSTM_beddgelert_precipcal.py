# Following Koch example, applied to Beddgelert using calibration based on precipitation

# Climate and Q files should be in a daily step and run from 1976 to 2021
...
#Set the calib, control and eval years
ini_calib = 1995 
end_calib =1998
ini_control = 1976
end_control = 1979
...
# read data
# days
day_data=pd.read_excel('C:/Users/erpasten/Documents/UEF/Hydropower/python/daily_dates_1976_2021.xlsx')
Year = day_data.Year
Month = day_data.Month
Day = day_data.Day


# data array order: Q, Pr, Tas, PET
data_all = np.zeros([len(Year),4])
precip=pd.read_csv('C:/Users/erpasten/Documents/UEF/Hydropower/data/climate/beddgelert/daily_rainfall_beddgelert_hadukgrid.csv', header=None)
pe=pd.read_csv('C:/Users/erpasten/Documents/UEF/Hydropower/data/climate/beddgelert/daily_pe_beddgelert_hadukgrid.csv',header=None)
tas=pd.read_csv('C:/Users/erpasten/Documents/UEF/Hydropower/data/climate/beddgelert/daily_tasmean_beddgelert_hadukgrid.csv',header=None)
discharge=pd.read_excel('C:/Users/erpasten/Documents/UEF/Hydropower/data/discharge/Beddgelert_1976_2021.xlsx',header=None)
...
data_all= np.concatenate((discharge,precip,tas,pe), axis=1)


data_calib = data_all[(Year>ini_calib-1) & (Year<end_calib+1)]
data_control= data_all[(Year>ini_control-1) & (Year<end_control+1)]
data_eval = data_all[(Year>ini_eval-1) & (Year<end_eval+1)]

data = np.concatenate((data_calib,data_control,data_eval),axis=0)
...
df.to_pickle('C:/Users/erpasten/Documents/UEF/Hydropower/data/ml/beddgelert_results_precipcal.pkl')
df.to_csv('C:/Users/erpasten/Documents/UEF/Hydropower/data/ml/beddgelert_results_precipcal.csv',index=False)
print(df)
...
plt.ylabel('Q [m3/day]')
plt.legend()
plt.title('Beddgelert Daily discharge - LSTM DSST for precipitation')
plt.grid('True')
...
#plt.xlim(0,10943)
plt.xlabel('Days')
plt.savefig('C:/Users/erpasten/Documents/UEF/Hydropower/figures/beddgelert_lstm_discharge_precipcal.png',dpi=400)
